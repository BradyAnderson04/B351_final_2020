...
class Game:
    ...
    def playGame(self):
        ...
        while not self.gameExit:
            ...
            # displaying score
            text = self.font.render(f"Score: {self.clock}",True,Game.white)
            self.gameDisplay.fill(Game.black)
...
class SimpleGame(Game):
    ...
    def playGame(self):
        ...
        while not self.gameExit:
            ...
            # displaying score - convert time from milleseconds to seconds
            text = self.font.render(f"Time: { Game.clock.get_time() / 1000 }",True,Game.white)
            self.gameDisplay.fill(Game.black)
            self.gameDisplay.blit(text, ((self.display_width - text.get_width()) // 2, (self.display_height - (text.get_height())) // 70))
